...
// Authentication Routes (zelf toegevoegd -> gaat de routes voor de authentication views zelf aanmaken)
//Route::auth();
...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::get('/tasks', 'TaskController@index');
    Route::get('/add_task', 'TaskController@new_task');
    Route::post('/task', 'TaskController@store');
    Route::delete('/task/{task}', 'TaskController@destroy');
    Route::put('/update_task/{task}', 'TaskController@update');
    
});

//al het onderstaande is nog van de quickstart -> mag eigenlijk weg
/*
Route::group(['middleware' => ['web']], function () {
    //
