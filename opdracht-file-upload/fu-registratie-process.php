...
if(isset($_POST["generate_password"])) {
    ...
    header("Location: fu-registratie-form.php");
}
            ...
            try {
                ...
                if(count($arrUsersEmail) == 0) {
                    ...
                    if($arrLastInserted[0]["email"] == $_SESSION["email"]) {
                        ...
                        //hier kwam je in als je bij de insert vergat een "" te inserten voor de profile_picture -> is opgelost nu
                        $_SESSION["message"] = "Fout in script. Sorry! <a href='mailto:sarah.jehin@student.kdg.be'>Breng ons op de hoogte</a> en we lossen het zo snel mogelijk op";
